            ...
            <div className="container mx-auto px-6 md:px-8 py-14">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2.5 text-sm text-muted-foreground">
                            ...
                            <li>
                                <Link href="/learn/system-design-fundamentals" className="hover:text-[var(--gold)] transition-colors">
                                    System Design
                                </Link>
                            </li>
                            <li>
                ...
                <div className="mt-12 pt-8 border-t border-border/30 flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div className="flex items-center gap-4">
                        <Link href="#" className="text-muted-foreground/60 hover:text-[var(--gold)] transition-colors">
